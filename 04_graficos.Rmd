...
<img src = "https://raw.githubusercontent.com/hadley/r4ds/master/diagrams/data-science-communicate.png"/>
...
<center> <img src = "www/criar_rmd.png"/> </center>
...
O código acima gera o seguinte resultado no documento:
...
A opção <a>eval</a> controla se o código será executado (avaliado) ou não.
...
A opção <a>echo</a> controla se o exibido no relatório ou não.
...
A opção <a>include</a> controla se código e seus resultados devem ser 
incluídos no relatório ou não.
...
Essa opção é geralmente usada no inicio do documento para carregar pacotes, 
ler dados, etc.
...
<center><img 
  src = "https://www.sccpre.cat/mypng/full/34-343872_r-shiny-logo-png.png"
  height = "200px"
/></center>
...
```{r, eval = FALSE}
# Nome da função
plotOutput("filmes") # id do Output
```
